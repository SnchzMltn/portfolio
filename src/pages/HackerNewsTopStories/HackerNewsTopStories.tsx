...
import {
  ...
  fetchTopStories,
} from "../../services/HackerNewsService/HackerNewsApiHelper";
import type { HackerNewsPost } from "../../services/HackerNewsService/HackerNewsPost";
      ...
      <Stack justifyContent="center" direction={"column"} spacing={6}>
        ...
        <Typography variant="h6">
          <Paper
            ...
            elevation={2}
          >
            Collection of top 20 posts in Y Combinator news section ordered by
            score (desc)
          </Paper>
        </Typography>
        <Stack direction={"row"} spacing={10}>
          {postsOutput && postsOutput.length > 0 ? (
            <table className="tableContainer" style={{ margin: 'auto' }}>
              <tbody>
